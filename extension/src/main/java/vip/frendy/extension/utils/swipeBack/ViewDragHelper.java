...
package vip.frendy.extension.utils.swipeBack;
...
public class ViewDragHelper {
    ...
    private ViewDragHelper(Context context, ViewGroup forParent, Callback cb) {
        ...
        mEdgeRightSize = (int) (EDGE_SIZE * density + 0.5f);
     ...
     * callback's
     * {@link vip.frendy.extension.utils.swipeBack.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link vip.frendy.extension.utils.swipeBack.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
    ...
    public void setEdgeRightSize(int size) {
        mEdgeRightSize = size;
    }
     ...
     * {@link vip.frendy.extension.utils.swipeBack.ViewDragHelper.Callback#tryCaptureView(View, int)}
     ...
     * {@link vip.frendy.extension.utils.swipeBack.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
    ...
    private int getEdgeTouched(int x, int y) {
        ...
        if (touchFlag) {
            ...
            result = edgeFlag;
            // right
            if (x > mParentView.getRight() - mEdgeRightSize)
                result = EDGE_RIGHT;
        } else {
            // original
            ...
            if (y < mParentView.getTop() + mEdgeSize)
                result = EDGE_TOP;
            if (x > mParentView.getRight() - /*mEdgeSize*/mEdgeRightSize)
                result = EDGE_RIGHT;
