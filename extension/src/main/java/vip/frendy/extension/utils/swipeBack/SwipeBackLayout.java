...
public class SwipeBackLayout extends FrameLayout {
    ...
    public void setEdgeRightSizePercent(float size) {
        mDragHelper.setEdgeRightSize((int) (getResources().getDisplayMetrics().widthPixels * size));
    }
    ...
    private class ViewDragCallback extends ViewDragHelper.Callback {
        ...
        public boolean tryCaptureView(View view, int i) {
            ...
            if (ret) {
                ...
                /**
                 * zichao.xu 2016.11.04
                 * Do not scroll when drag from edge right or buttom
                 */
                if(mTrackingEdge == EDGE_RIGHT || mTrackingEdge == EDGE_BOTTOM)
                    return false;
